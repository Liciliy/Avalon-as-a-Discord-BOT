...
class AvaGame:
    ...
    def __init__(self, 
        ...
        self.__voice_handler = VoiceChannelHandler(self)     
    ...
    async def lock_game(self, msg):
        ...
        await self.__voice_handler.create_channel_with_invite()
    ...
    async def check_if_joined_member_is_game_player(self, member):
        ...
        if self.game_state == const.GAME_LOCKED_STATE\
          ...
          and member.id in self.players_ids_list:
            ...
            await self.player_id_to_txt_ch_handler_dict[member.id].\
